-- Shared ScoreMore DEV / RankTiger PROD dynamic content seed.
-- Safe to rerun after `supabase db reset`.
-- BRAND SAFETY: product identity (app name, mark, environment) is build-controlled.
-- Never seed app_name/app_mark/app_environment here. This file must remain safe for both environments.
